...
head(mimimum_ibu,5)
```
The table above shows the top 5 beers lowest average IBU. The beer with the lowest average IBU is `r mimimum_ibu[[1,1]]` with an average ABV of `r round(mimimum_ibu[[1,2]],1)`,  whilst the next highest is `r mimimum_ibu[[2,1]]` with an average ABV of `r round(mimimum_ibu[[2,2]],1)`.
